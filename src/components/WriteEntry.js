    ...
    handleSubmit = (event) => {
        ...
        Promise.all([p1, p2])
            .then(() => {
                ...
                api.createSingleEntry(entryDataObj, auth.getToken()).then(
                    ...
                    <Grid.Column style={{ maxWidth: 700 }}>
                        ...
                        <Form size="big" widths="equal" onKeyPress={this.handleKeyPress}>
                            ...
                            <Form.Field >
                                ...
                                <Autocomplete
                                    style={{ width: '90%' }} onPlaceSelected={(place) => { this.setState({ place: place.formatted_address }); 
                            ...
                            <Button onClick={this.handleSubmit}>{this.state.loadingWrite?'Uploading...':'Submit'}</Button>
                        </Form>
